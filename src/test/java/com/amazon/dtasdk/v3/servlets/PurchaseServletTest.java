...
public class PurchaseServletTest extends InstantAccessServletTest {
    ...
    private static final SubscriptionResponseValue SUBSCRIPTION_ACTION_RESPONSE = SubscriptionResponseValue.FAIL_INVALID_SUBSCRIPTION;
    ...
    private class PurchaseServletImpl extends PurchaseServlet {
        ...
        public SubscriptionGetResponse processSubscriptionGet(SubscriptionGetRequest request) {
            ...
            response.setResponse(SUBSCRIPTION_ACTION_RESPONSE);
            return response;
        }
    ...
    public void testSubscriptionActivate() throws SigningException, IOException {
        ...
        Assert.assertEquals("{\"response\":\"" + SUBSCRIPTION_ACTION_RESPONSE + "\"}", output.toString());
    }
    ...
    @Test
    public void testSubscriptionUpdate() throws SigningException, IOException {
        HttpServletRequest request = EasyMock.createMock(HttpServletRequest.class);
        HttpServletResponse response = EasyMock.createMock(HttpServletResponse.class);
    ...
    @Test
    public void testSubscriptionGet() throws SigningException, IOException {
        HttpServletRequest request = EasyMock.createMock(HttpServletRequest.class);
        HttpServletResponse response = EasyMock.createMock(HttpServletResponse.class);
